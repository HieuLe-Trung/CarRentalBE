"""
Django settings for carRentalSales project.
...
SECRET_KEY = 'django-insecure-6)1u=n_wsw=wy#42$4smzj=b!pt%+$^&1wlj267auvkrfsj8)-'
...
WSGI_APPLICATION = 'carRentalSales.wsgi.application'
...
AUTH_USER_MODEL = 'carRentalSalesapp.User'
# Password validation
...
MEDIA_ROOT = '%s/carRentalSalesapp/static/' % BASE_DIR
MEDIA_URL = '/media/'
STATIC_URL = 'static/'
